<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AdminDeneyimlerimGuncelle.aspx.cs" Inherits="BlogWeb.AdminDeneyimlerimGuncelle" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
        <h2>DENEYİM GÜNCELLEME SAYFASI</h2>
    <form id="Form1" runat="server">
        <div class="form-group">
            ...
            <asp:Button ID="Button1" runat="server" Text="Deneyim Güncelle" CssClass="btn btn-primary" OnClick="Button1_Click"/>
        </div>
    </form>
</asp:Content>
