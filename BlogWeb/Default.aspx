...
<body id="page-top">
    <nav style="background-color:blue;" class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">
            <span class="d-block d-lg-none">Hasan VAROL</span>
            <span class="d-none d-lg-block">
                <img class="img-fluid img-profile rounded-circle mx-auto mb-2" src="/Dosyalar/img/cvphoto.png" alt="" style="width: 500px; height: 500px;">
            </span>
        </a>
    ...
    <div class="container-fluid p-0">
        ...
        <section class="resume-section p-3 p-lg-5 d-flex d-column" id="about">
            <asp:Repeater ID="Repeater1" runat="server">
                <ItemTemplate>
                    <div class="my-auto">
                        ...
                        <div class="subheading mb-5" style="margin-top: 10px;">
                            <p>
                            ...
                            <p>
                                <a href="hasanvarooll@gmail.com">
                                    <asp:Label Style="text-transform: lowercase;" ID="Label5" runat="server" Text='<%#Eval("MAIL") %>'></asp:Label>
                                </a>
                            </p>
                        </div>
                        <p class="lead mb-5">
            ...
            <div class="social-icons">
                <a href="https://www.linkedin.com/in/varol-hasan/">
                    <i class="fab fa-linkedin-in"></i>
                </a>
                <a href="https://github.com/varolhasan">
                    <i class="fab fa-github"></i>
                </a>
                <a href="https://twitter.com/vorhandenn">
                    <i class="fab fa-twitter"></i>
                </a>
                <a href="https://www.instagram.com/hasanvaroll/">
            ...
            <ul class="fa-ul mb-0">
                <asp:Repeater ID="Repeater5" runat="server">
                    <ItemTemplate>
                        <li>
                            <i>
                                <img src="/Dosyalar/img/certificate.png" /></i>
